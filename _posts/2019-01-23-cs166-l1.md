...
Before going further in the lecture, I mention another structure that has time complexity $\langle O(n), O(\log n) \rangle$. I learned about this in a [GeeksforGeeks post][geeks] by chance when looking up RMQ, and it was fun to find yet another structure that provides a pretty good runtime. That structure is the segment tree.
